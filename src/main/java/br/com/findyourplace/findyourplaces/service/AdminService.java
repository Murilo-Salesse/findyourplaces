...
public class AdminService {
	...
	public CreateAdminResponseDTO setupAdmin(CreateAdminRequestDTO req) {
		...
		if (qtdUsers > 0) {
			throw new AdminException("Problema ao registrar ADMIN.", "ADMIN só pode ser criado quando não há usuários no sistema.");
		}
		...
		return new CreateAdminResponseDTO(newUser.getId(),
										 newUser.getName(),
										 newUser.getEmail(),
										 newUser.getPhone(),
										 newUser.getStatus(),
